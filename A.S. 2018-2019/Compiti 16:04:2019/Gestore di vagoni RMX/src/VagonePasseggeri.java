...
public class VagonePasseggeri extends Vagone {
    ...
    public int getPeso() {
	return getPeso_vuoto() * (posti_occupati * 75);
    }
    ...
    public VagonePasseggeri clone() {
	return new VagonePasseggeri(getCodice(), getPeso_vuoto(), getAzienda(), getAnno(), classe, posti_disponibili, posti_occupati);
    }
}
