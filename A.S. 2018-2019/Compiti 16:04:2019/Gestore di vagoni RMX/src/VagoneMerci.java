...
public class VagoneMerci extends Vagone {
    ...
    public int getPeso() {
	return getPeso_vuoto() + peso_carico;
    }
    ...
    public VagoneMerci clone() {
	return new VagoneMerci(getCodice(), getPeso_vuoto(), getAzienda(), getAnno(), volume_carico, peso_massimo, peso_carico);
    }
}
